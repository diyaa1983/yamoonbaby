(function (global) {
    ...
    function ensureCelebrate() {
        ...
        style.textContent = [
            ...
            '#yamoonCelebrate .yc-shade{position:absolute;inset:0;z-index:1;background:linear-gradient(180deg,rgba(10,36,18,.08) 0%,rgba(8,28,16,.12) 48%,rgba(8,28,16,.22) 100%)}',
            '#ycFireworks{position:absolute;inset:0;width:100%;height:100%;z-index:3;pointer-events:none}',
            '#yamoonCelebrate .yc-card{position:relative;z-index:4;width:min(640px,92vw);background:rgba(255,255,255,.08);border:3px solid rgba(244,196,48,.85);border-radius:36px;padding:28px 22px 24px;text-align:center;box-shadow:0 18px 50px rgba(0,0,0,.18);backdrop-filter:blur(7px) saturate(1.15);-webkit-backdrop-filter:blur(7px) saturate(1.15)}',
            '#yamoonCelebrate .yc-label{color:#c2185b;font-weight:900;font-size:clamp(1.2rem,3vw,1.7rem);margin-bottom:14px;text-shadow:0 1px 0 #fff,0 2px 10px rgba(255,255,255,.95)}',
            '#yamoonCelebrate .yc-grid{display:grid;gap:10px}',
            '#yamoonCelebrate .yc-field{background:rgba(255,255,255,.12);border:1.5px solid rgba(255,255,255,.45);border-radius:18px;padding:10px 14px}',
            '#yamoonCelebrate .yc-k{display:block;color:#0b4f86;font-weight:800;font-size:.95rem;margin-bottom:2px;text-shadow:0 1px 0 #fff,0 0 10px rgba(255,255,255,.85)}',
            '#yamoonCelebrate .yc-num{direction:ltr;unicode-bidi:isolate;font-size:clamp(2.4rem,8vw,4.4rem);font-weight:900;letter-spacing:8px;color:#111;text-shadow:0 1px 0 #fff,0 0 14px rgba(255,255,255,.95)}',
            '#yamoonCelebrate .yc-name{font-size:clamp(1.5rem,4vw,2.3rem);font-weight:900;color:#0b4f86;text-shadow:0 1px 0 #fff,0 0 12px rgba(255,255,255,.9)}',
            '#yamoonCelebrate .yc-phone{direction:ltr;unicode-bidi:isolate;font-size:clamp(1.35rem,3.6vw,2rem);font-weight:800;color:#9d174d;text-shadow:0 1px 0 #fff,0 0 12px rgba(255,255,255,.9)}',
            '#yamoonCelebrate .yc-city{font-size:clamp(1.25rem,3.2vw,1.8rem);font-weight:800;color:#12315a;text-shadow:0 1px 0 #fff,0 0 12px rgba(255,255,255,.9)}',
