(function (global) {
    ...
    function ensureCelebrate() {
        ...
        style.textContent = [
            ...
            '#yamoonCelebrate .yc-card{position:relative;z-index:4;width:min(640px,92vw);background:rgba(255,253,247,.22);border:3px solid rgba(244,196,48,.9);border-radius:36px;padding:28px 22px 24px;text-align:center;box-shadow:0 28px 90px rgba(0,0,0,.28);backdrop-filter:blur(18px) saturate(1.2);-webkit-backdrop-filter:blur(18px) saturate(1.2)}',
            '#yamoonCelebrate .yc-label{color:#c2185b;font-weight:900;font-size:clamp(1.2rem,3vw,1.7rem);margin-bottom:14px;text-shadow:0 1px 0 #fff,0 0 12px rgba(255,255,255,.9)}',
            '#yamoonCelebrate .yc-grid{display:grid;gap:10px}',
            '#yamoonCelebrate .yc-field{background:rgba(255,255,255,.32);border:1.5px solid rgba(255,255,255,.62);border-radius:18px;padding:10px 14px}',
